...
public class Apple extends HealthActor implements Transform{

    public static final String APPLE_KEY = "sapling";
    public static final int APPLE_HEALTH_LIMIT = 5;
    public static final double APPLE_BEHAVIOR_PERIOD = 2.0;
    public static final double APPLE_ANIMATION_PERIOD = 0.01; // Very small to react to health changes
    public static final int APPLE_PARSE_PROPERTY_COUNT = 0;
     ...
     */
    public Apple(String id, Point position, List<PImage> images) {
        super(id, position, images, APPLE_ANIMATION_PERIOD, APPLE_BEHAVIOR_PERIOD, 0);
    }
    ...
    public void updateImage() {
        ...
        if (getHealth() <= 0) {
            setImageIndex(0);
        } else if (getHealth() < APPLE_HEALTH_LIMIT) {
