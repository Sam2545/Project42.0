...
public class WorldParser {
    ...
    private static Entity parseEntity(String parameters, ImageLibrary imageLibrary) {
        ...
        if (args.length >= Entity.ENTITY_PROPERTY_COLUMN_COUNT) {
            ...
            return switch (key) {
                ...
                case Farmer.FARMER_KEY -> parseFarmer(specificProperties, id, position, imageLibrary);
    ...
    private static Entity parseFarmer(String[] properties, String id, Point position, ImageLibrary imageLibrary) {
        if (properties.length == Farmer.FARMER_PARSE_PROPERTY_COUNT) {
            ...
            return new Farmer(
                    ...
                    Double.parseDouble(properties[Farmer.FARMER_PARSE_PROPERTY_ANIMATION_PERIOD_INDEX]),
                    Double.parseDouble(properties[Farmer.FARMER_PARSE_PROPERTY_BEHAVIOR_PERIOD_INDEX]),
                    0,
                    Integer.parseInt(properties[Farmer.FARMER_PARSE_PROPERTY_RESOURCE_LIMIT_INDEX])
            );
