...
public final class VirtualWorld extends PApplet {
    ...
    public void scheduleActions(World world, EventScheduler scheduler, ImageLibrary imageLibrary) {
        for (Entity entity : world.getEntities()) {
            if (entity instanceof AnimationActor) {
                ((AnimationActor)entity).scheduleActions(scheduler, world, imageLibrary);
            }
            else if (entity instanceof BehaviorActor) {
                ((BehaviorActor)entity).scheduleActions(scheduler, world, imageLibrary);
            }
